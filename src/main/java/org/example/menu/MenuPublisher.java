...
public class MenuPublisher {
    ...
    public static final String  SHOW_DRINK_ORDERS_COUNT_BY_DATE = "Show drink orders count by date";
    public static final String  SHOW_CUSTOMERS_WITH_DRINKS_TODAY = "Show customers with drinks today";
